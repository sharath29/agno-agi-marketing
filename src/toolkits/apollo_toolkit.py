...
class ApolloToolkit(Toolkit):
        ...
        try:
            ...
            for org in result.get("organizations", []):
                company = Company(
                    ...
                    industry=org.get("primary_industry", {}).get("industry") if org.get("primary_industry") else None,
                    size=org.get("employee_count"),
                    location=org.get("primary_phone", {}).get("source") if org.get("primary_phone") else None,
    ...
    def find_similar_companies(self, company_domain: str, limit: int = 10) -> Dict[str, Any]:
        ...
        try:
            ...
            similar_companies = [
                company for company in result.get("companies", [])
